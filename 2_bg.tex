...
\sm{It is important to remark that disagreement might not mean low quality. 
  As claimed for example by \citet{aroyo2015truth}, disagreement might
  depend on the false assumption of a ``unique truth'', it might carry
  useful information that can be exploited, and attempts to eliminate
  disagreement, for example by detailed instructions, might not
