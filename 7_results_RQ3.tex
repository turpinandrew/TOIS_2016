...
%%%  \end{itemize}
%%%  \aht{OK, i agree there is a confound that and this can be imrpoved.
...
\sm{The following sentence is... unclear}Table~\ref{tab:scaling-cats} shows this Kendall's $\tau$ for our 12
...
%the agregation function == median that is creating the floor of 2. Let's leave it as median in
...
\begin{tabular}{rccc}
\toprule
\multicolumn{1}{l}{Source of gains} & Narrow & All & Wide \\
\midrule
