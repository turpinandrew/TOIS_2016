...
\textcolor{red}{
Given that the  scores for document relevance that we have observed are 
distributed as seen previously in other tasks where magnitude estimation has been used, 
